...
public class List_Docteur_Dentiste extends AppCompatActivity {
    ...
    private static final String URL_LISTE_DOCTEURS = "http://169.254.197.128/docteur_serveur/get_liste_docteur_dentiste.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list__docteur__dentiste_activity);
        ...
        new List_Docteur_Dentiste.ListDocteursAsync().execute();
    }
    ...
    class ListDocteursAsync extends AsyncTask<String, String, JSONObject> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(List_Docteur_Dentiste.this);
        ...
        protected void onPostExecute(JSONObject json) {
            ...
            SimpleAdapter adapter = new SimpleAdapter(
                    List_Docteur_Dentiste.this, DocteursList,
