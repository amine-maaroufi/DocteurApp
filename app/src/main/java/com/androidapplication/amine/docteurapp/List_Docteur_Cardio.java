...
public class List_Docteur_Cardio extends AppCompatActivity implements ClassAddressIP {
    ...
    private static final String URL_LISTE_DOCTEURS = ClassAddressIP.adrip+"/docteur/get_liste_docteur_cardio.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list__docteur__cardio_activity);
        ...
        new List_Docteur_Cardio.ListDocteursAsync().execute();
    }
    ...
    class ListDocteursAsync extends AsyncTask<String, String, JSONObject> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(List_Docteur_Cardio.this);
            pDialog.setMessage("List of doctors ...");
        ...
        protected void onPostExecute(JSONObject json) {
            ...
            SimpleAdapter adapter = new SimpleAdapter(
                    List_Docteur_Cardio.this, DocteursList,
